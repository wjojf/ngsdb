...
class ImportCSVView(edit.FormView):
    ...
    def get(self, request, *args, **kwargs):
        formset_class = modelformset_factory(MuseumItem, formset=BaseUploadedFormSet, fields='__all__')
        formset = formset_class(data=request.POST, queryset=MuseumItem.objects.none())
        context = self.get_context_data()
        context['formset'] = formset
        context['tabs'] = build_tabs_dict[STRAINS_TAB]
    ...
    def post(self, request, *args, **kwargs):
        ...
        if formset.is_valid():
            ...
            return HttpResponseRedirect(reverse_lazy('museum_home_view'))
        else:
